...
<?php get_header(); 
/* Template Name: countries_germany */?>
...
<!--</div>-->
    ...
    <div class="inner-page-wrapper">
      <!-- BREADCRUMB
        ============================================= -->
      <div class="cmt-page-title-row" style="background: url('https://wcevs.com.au/wp-content/uploads/2021/03/image-11.jpg');width: 100%;background-size: cover;background-position: center;">
