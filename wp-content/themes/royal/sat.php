            ...
            <div class="col-lg-8">
              <div class="about-9-txt mb-40 pr-15 shadow br-15" style="padding: 25px;">
                  ...
                  <div class="col-md-4">
                    <div class="a9-box icon-xs">
                      ...
                      <div class="a9-txt">
                        ...
                        <p class="blue-color"><?php the_field('assessmeny');?></p>
                      </div>
                    </div>
                  </div>
                  <!-- ABOUT BOX #3 -->
                ...
                <div class="row">
                  <div class="col-lg-12">
                    <!-- Small Title -->
                    <h5 class="h5-md">Evidence-Based Reading & Writing</h5>
                    <!-- Text -->
                    <p><?php the_field('evidence-content');?>
                    </p>
                  </div>
                  <div class="col-lg-12">
                    <!-- Small Title -->
                    <h5 class="h5-md">Math</h5>
                    <!-- Text -->
                    <p><?php the_field('math-content');?></p>
                  </div>
                  
                </div>
                <!-- Small Title -->
                <h5 class="h5-md mt-25">SAT Eligibility:</h5>
                <!-- List -->
                <ul class="txt-list">
