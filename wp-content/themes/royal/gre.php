              ...
              <div class="about-9-txt mb-40 pr-15 shadow br-15" style="padding: 25px;">
                ...
                <div class="row">
                  <div class="col-lg-12">
                    ...
                    <!-- Text -->
                    <p>
                      <?php the_field('analytical-content');?>
                    </p>
                  </div>
                  <div class="col-lg-12">
                    <!-- Small Title -->
                    ...
                    <!-- Text -->
                    <p>
                      <?php the_field('quantitative-content');?>
                    </p>
                  </div>
                  <div class="col-lg-12">
                    <!-- Small Title -->
                    ...
                    <!-- Text -->
                    <p>
                      <?php the_field('verbal-content');?>
                    </p>
                  </div>
                </div>
                <!-- Small Title -->
                <h5 class="h5-md mt-25">GRE Eligibility:</h5>
                <!-- List -->
                <ul class="txt-list">
