<?php /* Template Name: course-detail */ ?>
<?php get_header(); ?>
          ...
          <div class="headtopparts clearfix">
            <div class="headerwp clearfix">
              <div class="headertopright header-contacts navbar-fixed-top">
                <span><a href="tel:01-4106567
" class="txt-grey b-right"><i class="fas fa-phone"></i>014106567</a>
</span>
            ...
            <div class="row align-items-center">
              <div class="col-lg-12">
                ...
                <div class="breadcrumb-wrapper">
                  <span>
                    <a class="white-color" title="Homepage" href="index.html">Home &nbsp;/</a>
                  </span>
                  <span>Services /</span>
                  <span>IELTS</span>
                </div>
