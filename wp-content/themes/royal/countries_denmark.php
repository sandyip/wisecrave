...
<?php get_header();
/* Template Name: countries_denmark */ ?>
...
<!--</div>-->
    ...
    <div class="inner-page-wrapper">
      <!-- BREADCRUMB
        ============================================= -->
      <div class="cmt-page-title-row" style="background: url('https://wcevs.com.au/wp-content/uploads/2021/01/wcevs-group-of-international-students-using-laptop.jpg');width: 100%;background-size: cover;background-position: center;">
