...
<?php get_header();
/* Template Name: countries_neitherland */ ?>
...
<!--</div>-->
    ...
    <div class="inner-page-wrapper">
      ...
      <div class="cmt-page-title-row">
        <div class="cmt-page-title-row-inner" style="background: url('https://wcevs.com.au/wp-content/uploads/2021/06/wise-crave-project-preperation.jpg');width: 100%;background-size: cover;background-position: center;">
          <div class="container">
